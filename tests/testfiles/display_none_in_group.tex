...
%  \begin{scope}[]
%    \path[draw=cff0000,fill=cff0000,opacity=0.700,draw opacity=0.992,line width=0.150cm] (8.6954, 19.6182) ellipse (1.6161cm and 1.6625cm);
%
%
%
%    \path[draw=cff0000,fill=cff0000,opacity=0.700,draw opacity=0.992,line width=0.150cm] (10.7062, 19.9881) ellipse (1.7713cm and 1.0947cm);
%
%
%
%  \end{scope}
